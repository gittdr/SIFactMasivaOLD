...
namespace FactLab
{
    public partial class SAD : Page
    {
        ...
        public bool adenda;
        string fecha, origen, origenRemitente, domicilioOrigen, rfcOrigen, destino, destinatario, domicilioDestino, rfcDestino,
        ...
        public void generaTXT()
        {
            ...
            using (System.IO.StreamWriter escritor = new System.IO.StreamWriter(path))
            {
                ...
                //if (clienteId.Equals("LIVERPOL") || clienteId.Equals("ALMLIVER") || clienteId.Equals("LIVERTIJ"))
                {
                    ...
                    {
                        serie = (checkAdenda.Checked == true ? "TDRL" : "TDRLD");
                        tipoFactura = "FAC";
                    }
