<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicial.aspx.cs" Inherits="FactLab.Inicial" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link rel="shortcut icon" href="img/icono-tdr-soluciones-logisticas.ico" />
...
box-shadow: 0px -33px 101px -48px rgba(237,237,9,1);">
          ...
          <div class="text-center text-lg-start mt-4 pt-2 pb-5">
            <asp:HyperLink ID="HyperLink16" CssClass="btn btn-lg btn-block  mt-5 shadow-lg" Style="font-family: 'Open Sans', sans-serif;color:black;background-color:#f2c43e;box-shadow: 1px 1px 82px 19px rgba(0,0,0,0.75);-webkit-box-shadow: 1px 1px 82px 19px rgba(0,0,0,0.75);-moz-box-shadow: 1px 1px 82px 19px rgba(0,0,0,0.75);" runat="server" NavigateUrl="~/Default.aspx"><b><i class="fa fa-sign-in" aria-hidden="true"></i> Ingresar</b></asp:HyperLink>
              <%--<asp:Button ID="btnGuarda" CssClass="btn btn-lg btn-block  mt-5 shadow-lg" Style="font-family: 'Open Sans', sans-serif;color:black;background-color:#f2c43e;box-shadow: 1px 1px 82px 19px rgba(0,0,0,0.75);-webkit-box-shadow: 1px 1px 82px 19px rgba(0,0,0,0.75);-moz-box-shadow: 1px 1px 82px 19px rgba(0,0,0,0.75);" runat="server" OnClick="Button1_Ingresar" Text="Ingresar" CausesValidation="False"  />
            --%>
          </div>
